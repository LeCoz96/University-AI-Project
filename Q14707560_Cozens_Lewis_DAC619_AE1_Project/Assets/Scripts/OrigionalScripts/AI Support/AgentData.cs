...
public class AgentData : MonoBehaviour
{
    ...
    public void Die()
    {
        ...
        DefenderCheck(); // A little bit of code I added to allow there to always be 1 defender
    ...
    private void DefenderCheck()
    {
        if (gameObject.GetComponent<BTDefender>().enabled)
        {
